...
export const formatPriceAge = (iso: string) => {
...
export interface BenchmarksObj {
  sp500: number;
  usBonds: number;
  usStocks: number;
}
...
export function GainBadge({ amount, pct, showArrow = true, chip = false }: { amount: number; pct: number; showArrow?: boolean; chip?: boolean }) {
...
export function PerformanceCards({ performanceData, period, isLoading }: {
...
export function PerformanceChart({ data, isLoading, hasHoldings }: { data?: HistoryPoint[]; isLoading: boolean; hasHoldings: boolean }) {
  return (
    <Card padding="lg">
      {isLoading ? (
...
export function PendingLotsCard({ lots }: { lots: PendingLot[] }) {
...
export function AllocationDonut({ data, isLoading }: { data?: AllocationData; isLoading: boolean }) {
...
export function AllocationTable({ data, isLoading }: { data?: AllocationData; isLoading: boolean }) {
  return (
    <Card padding="lg">
      <div style={{
        fontSize: '0.75rem',
