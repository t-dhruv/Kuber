...
import { fetchJournalReportRows, type JournalReportRow } from '../lib/journalReportingCore';
...
vi.mock('../lib/journalReportingCore', async () => {
  const actual = await vi.importActual<typeof import('../lib/journalReportingCore')>('../lib/journalReportingCore');
  return {
    ...actual,
